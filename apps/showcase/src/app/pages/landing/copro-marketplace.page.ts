...
@Component({
  selector: "swc-landing-copro-marketplace-page",
  template: `
    ...
    >
      <ng-container title>
        <span class="font-bold">La plateforme d’appel d’offres</span>
        de référence pour les syndics.
        <br />
        <span class="font-bold">Gratuit & Efficace.</span>
      </ng-container>
      ...
      <ng-container text>
        ...
        d’optimisation énergétique pour vos copropriétés.
      </ng-container>

      <ng-container partnerText>
        Plus de 3500 projets lancés par les plus grands syndics de copropriété
      </ng-container>
    </swc-hero-section-main>
    ...
    >
      <swc-structure-call-for-tenders>
        <ng-container title>
          <div class="font-bold">Structurez les appels d’offres</div>
          de vos copropriétés, en quelques clics.
        </ng-container>
      ...
      <swc-select-professionals>
        <ng-container title>
          ...
          <span class="font-bold">triés sur le volet pour la copropriété.</span>
        </ng-container>
      </swc-select-professionals>
...
export class LandingCoproMarketplacePageComponent {}
