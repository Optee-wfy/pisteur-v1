...
@Component({
  selector: "swc-politique-de-confidentialite-page",
  host: {
    class:
      "flex flex-col items-center justify-center gap-8 p-12 font-display relative overflow-hidden",
  },
  template: `
    <h1 class="text-5xl">Politique de confidentialité</h1>

    <oui-divider-vertical />

    <oui-circle class="-left-[519px] -top-[64px] w-[1071px]" theme="light" />

    <oui-circle class="-right-[600px] top-[1800px] w-[1071px]" theme="light" />

    <oui-circle class="-bottom-[64px] -left-[519px] w-[1071px]" theme="light" />

    <oui-circle
      class="-left-[519px] bottom-[4000px] w-[1071px]"
      theme="light"
    />

    <oui-circle
      class="-right-[600px] bottom-[1800px] w-[1071px]"
      theme="light"
    />
    ...
    <div class="prose max-w-prose text-justify">
      ...
      <p>
        <b>Client :</b>
        tout professionnel ou personne physique capable au sens des articles
      ...
      <p>
        ...
        <a href="https:/www.optee.net/">{{ SHOWCASE_LINK }}</a>
      ...
      <p>
        ...
        : CEELAB Capital social de 1000€ – 66 rue de la pompe 75116 Paris
        <br />
      ...
      <p>
        ...
        responsable du traitement des Données Personnelles est : Ceelab.
        <a href="{{ SHOWCASE_LINK }}">
          {{ SHOWCASE_LINK }}
        </a>
        est représenté par Maxime Weinstein, son représentant légal
      </p>
      ...
      Ceelab
      <br />
      66 rue de la pompe 75116 Paris.
      <p>
...
export class PolitiqueDeConfidentialitePageComponent {
  SHOWCASE_LINK = "https://www.optee.io/";
  CEELAB_LINK = "https://www.ceelab.fr/";
}
