...
import { DashboardPortfolioProComponent } from "../../../../components/dashboard/dashboard-portfolio/dashboard-portfolio-pro.component";
...
@Component({
  ...
  template: `
    <mkp-dashboard-portfolio-pro />

    <oui-radar-meet
      description="Accélérez votre développement grâce à votre agent dédié, qui facilite votre mise en relation avec des clients engagés"
      heading="Accompagnement Optee"
    />
  ...
  imports: [
    ...
    RadarMeetComponent,
    DashboardPortfolioProComponent,
  ],
